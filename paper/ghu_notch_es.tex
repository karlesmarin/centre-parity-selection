...
tres índices y la enumeración sobra. Eso es un enunciado sobre funciones simétricas, no sobre
este modelo; pertenece al programa de factorización de
Ciucu--Krattenthaler y Ayyer--Behrend~\cite{CiucuKrattenthaler,AyyerBehrend} y no a la
unificación gauge--Higgs, y se reporta allí y no aquí.
