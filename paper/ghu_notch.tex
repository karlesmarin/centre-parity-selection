...
is unnecessary. That is a statement about symmetric functions rather than about this model, it
belongs to the factorisation programme of
Ciucu--Krattenthaler and Ayyer--Behrend~\cite{CiucuKrattenthaler,AyyerBehrend} rather than to
gauge--Higgs unification, and it is reported there rather than here.
